...
const Staffadd = () => {
    ...
    const getinfo = (id) => {
        Apiconnect.getData(`users/getstaff/${id}`).then((response) => {
    ...
    const onSubmit = async (e) => {
        ...
        if (param.id > 0) {
            ...
            Apiconnect.postData(`users/updatestaff/${param.id}`, infoz).then((response) => {
                toast(response.data.message);
                navigate('/admin/Staff');
            });
        } else {
            await Apiconnect.postData('users/createstaff', infoz).then((response) => {
            ...
            <div className="row">
                <div className="col-md-6">
                    <div className="card-body cbtop">
                        <h2>{actn} User</h2>
                        <Link to={"/admin/Staff"} className="btn btn-success midbtn">
                            {' '}
