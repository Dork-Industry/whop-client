...
const ProductCard = ({product}) => {
  return (
    <a target="_blank" class="hover:bg-whop-hover border-whop-stroke group flex cursor-pointer flex-col items-stretch gap-2 overflow-x-hidden border-0 border-b border-solid p-5 transition md:flex-row md:items-center md:gap-5 md:rounded-lg md:border-b-0 md:p-4" href={`/product/${product?.prod_code}`}>
    <div class="border-whop-stroke aspect-[2/1] w-full overflow-hidden rounded-lg border-[0.5px] border-solid md:h-[110px] md:w-auto lg:h-[149px]">
       <div class="group relative flex aspect-[2/1] overflow-hidden">
          <div class="embla w-full">
             <div class="embla__container flex h-full flex-row " >
                <div class="embla__slide aspect-[2/1] h-full w-full object-cover transition-all duration-200">
                   <video class="h-full w-full" src="https://img.whop.com/mrnyB4nUs5RJEvIX0IdBTeMQIZ4Zl9rB77f79mLCJ7s/rs:fill:440:220/el:1/dpr:2/aHR0cHM6Ly9hc3NldHMud2hvcC5jb20vaW1hZ2VzL2ltYWdlcy81NDEyNS5vcmlnaW5hbC5naWY.mp4" playsinline="" loop="" muted="" width="440" height="220" ></video>
                </div>
             </div>
          </div>
       </div>
       ...
       <div class="flex gap-6 overflow-hidden">
          <div class="flex-1 overflow-hidden">
             ...
             <div data-headlessui-state="">
                <div class="group/reviews relative flex w-min flex-nowrap items-center gap-1">
                   ...
                   <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="chevron-down" class="svg-inline--fa fa-chevron-down text-whop-gray text-[8px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                   ...
                   <div class="subtitle4">4.97</div>
                   <div class="text4 text-whop-dark-gray">
                  {`(825)`}
                   </div>
                </div>
             </div>
             <div ></div>
             <div class="text1 text-whop-dark-gray my-3 hidden max-h-[39px] overflow-hidden [-webkit-box-orient:vertical] [-webkit-line-clamp:2] md:[display:-webkit-box]">Welcome to Profit Lounge, the #1 reselling community on Discord! 
             {product?.short_info}
             </div>
          </div>
          <div>
             <div class="button4 text-right">{product?.base_price}</div>
             <div class="text-whop-gray text-right text-xs">/month</div>
          </div>
       </div>
       <div class="text3 text-whop-dark-gray overflow-x-hidden py-1.5 md:hidden">
          <div class="line-clamp-3">
            {product?.short_info}
          </div>
       </div>
       <div class="text5 text-whop-gray flex items-center gap-1 overflow-x-hidden">
          <div class="whitespace-nowrap">Reselling</div>
          <div>•</div>
          <div class="whitespace-nowrap">General</div>
       </div>
    </div>
 </a>  )
}
