...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-whop-stroke bg-whop-background border cursor-pointer rounded-lg">
      ...
      <div
        className={`grid overflow-hidden transition-all duration-300 ${isOpen ? '[grid-template-rows:1fr]' : '[grid-template-rows:0fr]'
          }`}
      >
...
const Faq = ({ storeFaqs }) => {
  console.log("storeFaqs in faq", storeFaqs)
  return (
    <div className="border-t-whop-stroke flex flex-col gap-6 border-t py-10 md:py-16 lg:flex-row lg:gap-6">
      ...
      <div className="lg:flex-1 lg:basis-[360px]">
        <div className="space-y-4">
          {storeFaqs && storeFaqs.length && storeFaqs.map((faq, index) => {
            return (
              <FaqItem
