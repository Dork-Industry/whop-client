      ...
      <div className="border-t-whop-stroke flex flex-col gap-6 border-t py-10 md:py-16 lg:flex-row lg:gap-6">
         ...
         <div className="lg:flex-1 lg:basis-[360px]">
            <div className="space-y-6">
               <div className="flex items-center gap-6">
                  ...
                  <div className="flex flex-col">
                     <div className="mb-1 flex items-center gap-1.5">
                        <div className="display3 text-whop-black">{storeData.store_name}</div>
               ...
               <div className="text-paragraph2 text-whop-black whitespace-pre-wrap">{storeData.store_info}
               </div>
            </div>
            {storeData.facebook && (
               <div className="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
                  <div className="text-whop-gray flex items-center gap-1.5">
                     ...
                     <div className="text-text3">Facebook</div>
                  </div>
                  <Link className="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" to={storeData.facebook}>
                     <div className="text-subtitle3">{storeData.facebook}</div>
                  </Link>
               </div>
            )}
            ...
            {storeData.instagram && (
               <div className="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
                  ...
                  <Link className="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" to={storeData.instagram}>
                     <div className="text-subtitle3">{storeData.instagram}</div>
                  </Link>
               </div>
            )}
            ...
            {storeData.youtube && (
               <div className="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
                  <div className="text-whop-gray flex items-center gap-1.5">
                     ...
                     <div className="text-text3">Youtube</div>
                  </div>
                  <Link className="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" to={storeData.youtube}>
                     <div className="text-subtitle3">{storeData.youtube}</div>
                  </Link>
               </div>
            )}
            ...
            {storeData.twitter && (
               <div className="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
                  ...
                  <Link className="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" to={storeData.twitter}>
                     <div className="text-subtitle3">{storeData.twitter}</div>
                  </Link>
               </div>
            )}
         </div>
