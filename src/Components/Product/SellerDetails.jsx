...
<div class="border-t-whop-stroke flex flex-col gap-6 border-t py-10 md:py-16 lg:flex-row lg:gap-6">
   <div class="flex-1">
      <div class="font-display text-display3">About the seller</div>
   </div>
   <div class="lg:flex-1 lg:basis-[360px]">
      <div class="space-y-6">
         <div class="flex items-center gap-6">
            <img class="border-whop-stroke border-[0.5px] rounded-2xl object-cover w-16 h-16" src="https://img.whop.com/tVjPaYTPvFlvpxifDtv0cZKdyNaLZtEBTY_f0ckuXe0/rs:fill:64:64/el:1/aHR0cHM6Ly9hc3NldHMud2hvcC5jb20vYm90cy9pbWFnZXMvMzY2Lm9yaWdpbmFsLnBuZw" alt="Company image" width="64" height="64" loading="lazy" fetchpriority="auto" srcset="https://img.whop.com/tVjPaYTPvFlvpxifDtv0cZKdyNaLZtEBTY_f0ckuXe0/rs:fill:64:64/el:1/aHR0cHM6Ly9hc3NldHMud2hvcC5jb20vYm90cy9pbWFnZXMvMzY2Lm9yaWdpbmFsLnBuZw 1x, https://img.whop.com/rrBNaF15drpPZMXyRGpLD_lgfyfOv10NwrP-i22gbiE/rs:fill:64:64/el:1/dpr:2/aHR0cHM6Ly9hc3NldHMud2hvcC5jb20vYm90cy9pbWFnZXMvMzY2Lm9yaWdpbmFsLnBuZw 2x" />
            <div class="flex flex-col">
               <div class="mb-1 flex items-center gap-1.5">
                  <div class="display3 text-whop-black">Profit Lounge</div>
                  <div data-state="closed" class="text-whop-brandsDiscord focus:outline-none cursor-default inline-block">
                     <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="badge-check" class="svg-inline--fa fa-badge-check fa-fw text-whop-field-highlight" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
               ...
               <div class="text-whop-dark-gray text-text3">
                  Reselling   • General
               </div>
               <button class="text-whop-gray hover:text-whop-dark-gray text-text3 mt-1 flex cursor-pointer flex-row items-center gap-2 hover:underline">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="flag" class="w-5 h-5 text-[10px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
         ...
         <div class="text-whop-black flex gap-6 overflow-x-auto">
            <div class="flex items-center gap-2">
               <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="svg-inline--fa fa-star fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                  <path fill="currentColor" d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path>
               </svg>
               <p class="text-paragraph2 whitespace-nowrap">
                  875  review s
               </p>
            </div>
            <div class="flex flex-nowrap items-center gap-2">
               <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="badge-check" class="svg-inline--fa fa-badge-check fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <path fill="currentColor" d="M256 0c36.8 0 68.8 20.7 84.9 51.1C373.8 41 411 49 437 75s34 63.3 23.9 96.1C491.3 187.2 512 219.2 512 256s-20.7 68.8-51.1 84.9C471 373.8 463 411 437 437s-63.3 34-96.1 23.9C324.8 491.3 292.8 512 256 512s-68.8-20.7-84.9-51.1C138.2 471 101 463 75 437s-34-63.3-23.9-96.1C20.7 324.8 0 292.8 0 256s20.7-68.8 51.1-84.9C41 138.2 49 101 75 75s63.3-34 96.1-23.9C187.2 20.7 219.2 0 256 0zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"></path>
               </svg>
               <p class="text-paragraph2 whitespace-nowrap">Whop Verified</p>
            </div>
         </div>
         <div class="text-paragraph2 text-whop-black whitespace-pre-wrap">Welcome to Profit Lounge, the #1 reselling community on Discord! 
      ...
      <div class="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
         <div class="text-whop-gray flex items-center gap-1.5">
            ...
            <div class="text-text3">TikTok</div>
         </div>
         <a class="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" href="https://tiktok.com/@loungeprofit">
            <div class="text-subtitle3">@loungeprofit</div>
         </a>
      </div>
      <div class="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
         <div class="text-whop-gray flex items-center gap-1.5">
            ...
            <div class="text-text3">Discord</div>
         </div>
         <a class="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" href="https://discord.gg/profitlounge">
            <div class="text-subtitle3">https://discord.gg/profitlounge</div>
         </a>
      </div>
      <div class="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
         <div class="text-whop-gray flex items-center gap-1.5">
            ...
            <div class="text-text3">Twitter</div>
         </div>
         <a class="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" href="https://twitter.com/profit_lounge">
            <div class="text-subtitle3">@profit_lounge</div>
         </a>
      </div>
      <div class="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
         <div class="text-whop-gray flex items-center gap-1.5">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="globe" class="svg-inline--fa fa-globe " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="text-text3">Website</div>
         </div>
         <a class="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" href="https://profitlounge.us">
            <div class="text-subtitle3">profitlounge.us</div>
         </a>
      </div>
      <div class="border-whop-stroke flex justify-between border-b-[0.5px] py-4">
         <div class="text-whop-gray flex items-center gap-1.5">
            ...
            <div class="text-text3">Instagram</div>
         </div>
         <a class="text-whop-field-highlight flex cursor-pointer items-center gap-0.5" target="_blank" href="https://instagram.com/profit_lounge">
            <div class="text-subtitle3">@profit_lounge</div>
         </a>
      </div>
   </div>
