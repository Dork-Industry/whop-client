  ...
  return (
    ...
    <div className="border-whop-stroke-dark bg-whop-background w-full rounded-[10px] px-10 py-6 border">
       <div className="mx-auto flex max-w-[400px] flex-col gap-6 text-center">
          ...
          <div>
             <p className="text-whop-off-black text-header4">No orders yet</p>
             <p className="text-whop-dark-gray mt-1 text-paragraph3">When you purchase a product on Whop, it’ll show up here.</p>
          </div>
          <div className="mx-auto flex w-full flex-col-reverse gap-2 sm:flex-row sm:justify-center">
             <button type="button" className="group/button relative flex shrink-0 items-center justify-center overflow-hidden rounded-md focus-visible:border-whop-field-highlight focus-visible:ring-whop-field-highlight/30 outline-none transition focus:outline-none focus-visible:border focus-visible:ring w-full sm:w-auto bg-whop-primary text-whop-fixed-white text-button4 h-10 px-[15px]">
                <div className="absolute inset-0 transition group-hover/button:bg-black/[12%] group-active/button:bg-black/[18%]"></div>
                <div className="z-10 flex items-center justify-center">
                   <div className="text-white">Browse products</div>
                </div>
             </button>
          </div>
       </div>
