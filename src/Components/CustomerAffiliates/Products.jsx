        ...
        <div>
            <div className="space-y-10">
                    ...
                    <div className="flex-1 overflow-y-auto overscroll-contain p-4">
                        <div className="sticky flex flex-col gap-6 pt-2">
                            <div className="md:hidden">
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="circle" className="svg-inline--fa fa-circle text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <div>
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    ...
                                    <div className="text3 text-whop-off-black flex-1">Personal Finance</div>
                                    <div className="text3 text-whop-dark-gray text-right">6</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Students</div>
                                    <div className="text3 text-whop-dark-gray text-right">68</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Skylight Gaming</div>
                                    <div className="text3 text-whop-dark-gray text-right">3</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Sports Picks</div>
                                    <div className="text3 text-whop-dark-gray text-right">542</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Skylight Student</div>
                                    <div className="text3 text-whop-dark-gray text-right">1</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Skylight Templates</div>
                                    <div className="text3 text-whop-dark-gray text-right">2</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">127</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Life Hacks</div>
                                    <div className="text3 text-whop-dark-gray text-right">43</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Reselling</div>
                                    <div className="text3 text-whop-dark-gray text-right">310</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Social Media</div>
                                    <div className="text3 text-whop-dark-gray text-right">70</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Trading</div>
                                    <div className="text3 text-whop-dark-gray text-right">677</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Gaming</div>
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    ...
                                    <div className="text3 text-whop-off-black flex-1">Skylight Opensource</div>
                                    <div className="text3 text-whop-dark-gray text-right">4</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    </svg>
                                    <div className="text3 text-whop-off-black flex-1">Skylight Business</div>
                                    <div className="text3 text-whop-dark-gray text-right">3</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    ...
                                    <div className="text3 text-whop-off-black flex-1">Saas</div>
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    ...
                                    <div className="text3 text-whop-off-black flex-1">Business</div>
                                    <div className="text3 text-whop-dark-gray text-right">133</div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">655</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">183</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">412</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">304</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">224</div>
                                </div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" className="w-3 h-3 text-whop-strokeDark text-[20px] md:text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path>
                                    ...
                                    <div className="text3 text-whop-dark-gray text-right">144</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex gap-16">
                    <div className="hidden min-w-[206px] md:block">
                        <div className="sticky flex flex-col gap-6 pt-2">
                            <div className="md:hidden">
                                <div className="button4 pb-2 md:pl-[14px]">Sort By</div>
                                <div className="hover:bg-whop-hover -mx-1 flex cursor-pointer select-none items-center gap-2.5 rounded px-1 py-[7.5px] transition md:md:pl-[14px] md:pr-[10px]">
                    ...
                    <div className="w-full space-y-6 overflow-hidden">
                        <div className="flex items-center justify-between">
                            <h5 className="text-whop-black">1969 products</h5>
                            <div className="flex cursor-pointer items-center gap-1.5 md:hidden">
                                <div className="text2">Sort &amp; Filter</div>
                                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="sliders" className="svg-inline--fa fa-sliders fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <div className="relative flex items-center">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <span className="sm:text-sm">
                                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="magnifying-glass" className="svg-inline--fa fa-magnifying-glass fa-fw text-whop-dark-gray/[75%] absolute top-1/2 -translate-y-1/2 h-[16px] w-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="currentColor" d="M368 208A160 160 0 1 0 48 208a160 160 0 1 0 320 0zM337.1 371.1C301.7 399.2 256.8 416 208 416C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208c0 48.8-16.8 93.7-44.9 129.1L505 471c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0L337.1 371.1z"></path>
                                        </svg>
                                    </span>
                                </div>
                                <input data-hj-allow="true" placeholder="Search products" autocomplete="off" spellcheck="false" autocorrect="off" className="block w-full appearance-none pr-3 border-whop-stroke-dark focus-within:border-whop-field-highlight focus-within:ring-whop-field-highlight/30 border transition focus-within:outline-none focus-within:ring placeholder:text-whop-dark-gray/[50%] text-whop-black text-text1 outline-none h-10 rounded-md pl-[34px] bg-whop-hover shadow-none" type="search" value="" />
                            </div>
                        </div>
                        {/* table desktop */}
                            ...
                            <div className="flex min-h-0 flex-col">
                                <div className="flex-1 overflow-x-auto">
                                    <table cellpadding="8" className="w-full table-auto overflow-hidden">
                                        <thead className="border-whop-stroke border-b">
                                            <tr>
                                                <th colspan="1" className="text-overline4 group whitespace-nowrap py-[11px] text-left uppercase  w-[150px]" >
                                                    <div className="flex items-center text-whop-black">product</div>
                                                </th>
                                                <th colspan="1" className="text-overline4 group whitespace-nowrap py-[11px] text-left uppercase w-[150px]" >
                                                    <div className="flex items-center text-whop-black">rating</div>
                                                </th>
                                                <th colspan="1" className="text-overline4 group whitespace-nowrap py-[11px] text-left uppercase w-[150px]" >
                                                    <div className="flex items-center text-whop-black">Price</div>
                                                </th>
                                                <th colspan="1" className="text-overline4 group whitespace-nowrap py-[11px] text-left uppercase w-[150px]" >
                                        ...
                                        <tbody className="">
                                            <tr className="border-whop-stroke !border-b">
                                                <td className="text-text3 text-whop-black overflow-hidden whitespace-nowrap w-[150px]" >
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="space-y-0.5">
                                                            <div className="subtitle3">Wealth Group</div>
                                                            <div className="text4 text-whop-dark-gray">Unlock Crypto Wealth: Expert Education, Charts &amp; Exclusive Community</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="text-text3 text-whop-black overflow-hidden whitespace-nowrap" >
                                                ...
                                                <td className="text-text3 text-whop-black overflow-hidden whitespace-nowrap" >$225.00 /month</td>
                                                <td className="text-text3 text-whop-black overflow-hidden whitespace-nowrap" >
                                                    <div className="inline-flex w-auto items-center justify-center rounded px-1.5 text-subtitle4 h-[18px] bg-whop-tag-green-background text-whop-tag-green">15% recurring</div>
                                                </td>
                                                <td className="text-text3 text-whop-black overflow-hidden whitespace-nowrap" >
                                                    <div className="flex w-full justify-end">
                                                        <button type="button" className="group/button relative flex shrink-0 items-center justify-center overflow-hidden rounded-md w-fit focus-visible:border-whop-field-highlight focus-visible:ring-whop-field-highlight/30 outline-none transition focus:outline-none focus-visible:border focus-visible:ring bg-whop-primary text-whop-fixed-white text-button4 h-10 px-[15px]">
                                                            <div className="absolute inset-0 transition group-hover/button:bg-black/[12%] group-active/button:bg-black/[18%]"></div>
                                                            <div className="z-10 flex items-center justify-center">
                                                                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="link-simple" className="svg-inline--fa fa-link-simple fa-fw mr-[7px] text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                ...
                                <div className="flex w-full justify-between">
                                    <div className="flex items-center gap-x-2">
                                        <button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition border-whop-black border-2">1</button><button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition">2</button><button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition">3</button>
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" className="svg-inline--fa fa-ellipsis fa-fw text-whop-gray" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path fill="currentColor" d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"></path>
                                        </svg>
                                        <button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition">197</button>
                                    </div>
                                    <div className="flex items-center gap-x-[10px]">
                                        <p className="text-text4 text-whop-gray hidden whitespace-nowrap sm:block">Showing 1 - 10 of 1969</p>
                                        <div className="flex gap-x-2">
                                            <button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md font-medium tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition cursor-not-allowed opacity-40 text-[14px]" disabled="">
                                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-left" className="svg-inline--fa fa-chevron-left fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                            ...
                                            <button className="text-whop-black flex h-8 w-8 items-center justify-center rounded-md font-medium tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition text-[14px]">
                                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" className="svg-inline--fa fa-chevron-right fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
