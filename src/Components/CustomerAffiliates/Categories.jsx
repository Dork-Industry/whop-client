  ...
  return (
   ...
   <div class="flex min-h-0 flex-col">
      <div class="flex-1 overflow-x-auto">
         <table cellpadding="8" class="w-full table-auto overflow-hidden">
            <thead class="border-whop-stroke border-b">
               <tr>
                  <th colspan="1" class="w-[150px] text-overline4 group whitespace-nowrap py-[11px] text-left uppercase">
                     <div class="flex items-center text-whop-black cursor-pointer select-none">
                        product
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sort" class="w-4 h-4 fa-sort fa-fw text-whop-gray/40 group-hover:text-whop-gray h-2.5 w-2.5 transition-all" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            ...
            <tbody class="">
               <tr class="border-whop-stroke  !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="house" class="w-4 h-4 fa-house fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <div class="subtitle3">Home (whop.com)</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
                        <div class="inline-flex w-auto items-center justify-center rounded px-1.5 text-subtitle4 h-[18px] bg-whop-tag-green-background text-whop-tag-green">Variable reward</div>
                     </div>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div class="flex w-full justify-end">
                        <button type="button" class="group/button relative flex shrink-0 items-center justify-center overflow-hidden rounded-md w-fit focus-visible:border-whop-field-highlight focus-visible:ring-whop-field-highlight/30 outline-none transition focus:outline-none focus-visible:border focus-visible:ring bg-whop-primary text-whop-fixed-white text-button4 h-10 px-[15px]">
                           ...
                           <div class="z-10 flex items-center justify-center">
                              <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="link-simple" class="w-4 h-4 fa-link-simple fa-fw mr-[7px] text-[16px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/reselling/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="cart-shopping-fast" class="w-4 h-4 fa-cart-shopping-fast fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <div class="subtitle3">Reselling</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/trading/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="arrow-trend-up" class="w-4 h-4 fa-arrow-trend-up fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <div class="subtitle3">Trading</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/sports-picks/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="futbol" class="w-4 h-4 fa-futbol fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div class="subtitle3">Sports picks</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/ecommerce/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="truck-fast" class="w-4 h-4 fa-truck-fast fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <div class="subtitle3">E-commerce</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/life-hacks/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="wand-magic-sparkles" class="w-4 h-4 fa-wand-magic-sparkles fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <div class="subtitle3">Life hacks</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/business/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="chart-simple" class="w-4 h-4 fa-chart-simple fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <div class="subtitle3">Business</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/students/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="backpack" class="w-4 h-4 fa-backpack fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <div class="subtitle3">Students</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/gaming/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="gamepad-modern" class="w-4 h-4 fa-gamepad-modern fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <div class="subtitle3">Gaming</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
               ...
               <tr class="border-whop-stroke !border-b">
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <a class="flex items-center gap-2" target="_blank" href="/categories/social-media/">
                        <div class="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
                           <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="thumbs-up" class="w-4 h-4 fa-thumbs-up fa-fw text-whop-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div class="subtitle3">Social media</div>
                     </a>
                  </td>
                  <td class="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <div data-state="closed" class="text-whop-gray focus:outline-none cursor-default inline-block">
      ...
      <div class="flex w-full justify-between">
         <div class="flex items-center gap-x-2"><button class="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition border-whop-black border-2">1</button><button class="text-whop-black flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium leading-[17px] tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition">2</button></div>
         <div class="flex items-center gap-x-[10px]">
            <p class="text-text4 text-whop-gray hidden whitespace-nowrap sm:block">
               Showing  1  -  10  of  12
            </p>
            <div class="flex gap-x-2">
               <button class="text-whop-black flex h-8 w-8 items-center justify-center rounded-md font-medium tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition cursor-not-allowed opacity-40 text-[14px]" disabled="">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-left" class="w-4 h-4 fa-chevron-left fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
               ...
               <button class="text-whop-black flex h-8 w-8 items-center justify-center rounded-md font-medium tracking-[-0.01em] hover:bg-whop-hover active:bg-whop-hover-press outline-none transition text-[14px]">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" class="w-4 h-4 fa-chevron-right fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
