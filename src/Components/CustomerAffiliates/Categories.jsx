      ...
      <div className="flex-1 overflow-x-auto">
         <table cellpadding="8" className="w-full table-auto overflow-hidden">
               ...
               <tr>
                  <th colspan="1" className="w-[150px] text-overline4 group whitespace-nowrap py-[11px] text-left uppercase">
                     <div className="flex items-center text-whop-black cursor-pointer select-none">
                        product
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sort" className=" fa-sort fa-fw text-whop-gray/40 group-hover:text-whop-gray h-2.5 w-2.5 transition-all" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            ...
            <tbody className="">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/reselling/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/trading/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/sports-picks/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/ecommerce/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/life-hacks/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/business/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/students/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/gaming/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
               ...
               <tr className="border-whop-stroke !border-b">
                  <td className="w-[150px] text-text3 text-whop-black overflow-hidden py-1 whitespace-nowrap">
                     <Link className="flex items-center gap-2" target="_blank" to={"/categories/social-media/"}>
                        <div className="border-whop-stroke flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px]">
