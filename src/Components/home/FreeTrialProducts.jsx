  ...
  return (
   ...
   <div class="">
      <div class="flex items-end">
         <div class="flex-1">
            <h2 class="text-2xl font-bold">Free Trial Products</h2>
            <div class="paragraph2 text-whop-dark-gray mt-1 hidden md:block">Popular products with free trials.</div>
         </div>
...
export default FreeTrialProducts