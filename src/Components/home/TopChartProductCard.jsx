...
const TopChartProductCard = ({product}) => {
  return (
    <a class="flex flex-1 items-center gap-4 overflow-hidden" href="/marketplace/blitzer-ai/">
    ...
    <div class="border-whop-stroke flex flex-1 items-stretch gap-2 overflow-hidden border-b-[0.5px] border-l-0 border-r-0 border-t-0 border-solid py-3">
       <div class="subtitle3 w-[19px]">{product?.no}</div>
       <div class="flex flex-1 gap-2 overflow-hidden">
          <div class="flex-1 overflow-hidden">
             <div class="flex gap-2">
                <div class=" flex-1 overflow-hidden">
                   <div class="flex items-center gap-1 overflow-hidden">
                      <div class="subtitle1 overflow-hidden text-ellipsis whitespace-nowrap">Blitzer.Ai ⚡</div>
                   </div>
                   <div class="text3 text-whop-dark-gray mt-0.5 overflow-hidden text-ellipsis whitespace-nowrap">$1-$2 A DAY FOR THE MOST PROFITABLE AI BASED BETTING MODELS &amp; PICKS 📈</div>
                </div>
             </div>
             <div class="text5 text-whop-gray mt-1.5 flex items-center gap-1 whitespace-nowrap">
                ...
                <div class="whitespace-nowrap">Sports Picks</div>
                <div>•</div>
                <div class="whitespace-nowrap">Betting Algorithms</div>
                <div>•</div>
                <div class="whitespace-nowrap">Discord</div>
             </div>
          </div>
          <div>
             <div class="button4 text-right">$15.00</div>
             <div class="text-whop-gray mt-0.5 text-right text-[9px]">/week</div>
             <div class="subtitle5 mt-1.5 rounded-[2px] bg-[#E6F7CF] px-[5px] py-[1.5px] text-[#38863E]">Free Trial</div>
          </div>
       </div>
    </div>
 </a>
