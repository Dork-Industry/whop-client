   ...
   <div className="">
      <div className="flex items-end">
         <div className="flex-1">
            <h2 className="text-2xl font-bold">Whop Picks </h2>
            <div className="paragraph2 text-whop-dark-gray mt-1 hidden md:block">Hand picked products from the Whop team.</div>
         </div>
...
export default WhopPicksProducts