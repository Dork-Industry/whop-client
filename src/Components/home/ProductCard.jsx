...
const ProductCard = ({val}) => {
  return (
    <div  class="ml-2 shrink-0 snap-start first-of-type:ml-0 sm:ml-3 sm:first-of-type:ml-0 lg:ml-5 lg:first-of-type:ml-0 w-[93%] sm:w-[calc(50%-6px)] lg:w-[calc(33.333%-13.5px)]">
