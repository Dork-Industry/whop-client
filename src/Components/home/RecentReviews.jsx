...
const RecentReviews = () => {
  return (
<div class="padded-container py-8 md:py-[60px]">
   <div class="">
      <div class="flex items-end">
         <div class="flex-1">
            <div class="display3">Recent Reviews</div>
         </div>
      ...
      <div class="relative mt-6">
         ...
         <div class="-mx-2 -my-5 flex snap-mandatory scroll-p-3 gap-2 flex-nowrap overflow-x-auto px-2 py-5 sm:snap-x">
         {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(() => (
            ...
            <div class="ml-2 shrink-0 snap-start first-of-type:ml-0 sm:ml-3 sm:first-of-type:ml-0 lg:ml-5 lg:first-of-type:ml-0 w-[93%] sm:w-[calc(50%-6px)] md:w-[calc(33.333%-8px)] lg:w-[calc(25%-15px)]">
               <a class=" border-whop-stroke block cursor-pointer rounded-[10px] border border-solid p-4 shadow-md transition duration-300 ease-in-out  hover:scale-[102%]  hover:shadow-lg " href="/marketplace/thehaven/">
                  <div class="mb-4 flex items-center gap-2">
                     <img class="border-whop-stroke border-[0.5px] rounded-full object-cover w-10 h-10"  src="https://img.whop.com/cfhBUc9jbeqYhlOkUCJDDy3E0U6VDo_IcSuLE72L4o8/rs:fill:40:40/el:1/aHR0cHM6Ly9jZG4uZGlzY29yZGFwcC5jb20vYXZhdGFycy8xNzY1MTg2OTc1Mzg1NTE4MDgvNTU2YjU5ZDdlZGMxZmJiOTQ4NDQ3YjhhYzBkZjk1YWY" alt="Reviewer avatar" width="40" height="40" loading="lazy" fetchpriority="auto" srcset="https://img.whop.com/cfhBUc9jbeqYhlOkUCJDDy3E0U6VDo_IcSuLE72L4o8/rs:fill:40:40/el:1/aHR0cHM6Ly9jZG4uZGlzY29yZGFwcC5jb20vYXZhdGFycy8xNzY1MTg2OTc1Mzg1NTE4MDgvNTU2YjU5ZDdlZGMxZmJiOTQ4NDQ3YjhhYzBkZjk1YWY 1x, https://img.whop.com/7jnKzk6zhmymhvyxP2pV7jOczt7nyzrm0dEK41IiuMU/rs:fill:40:40/el:1/dpr:2/aHR0cHM6Ly9jZG4uZGlzY29yZGFwcC5jb20vYXZhdGFycy8xNzY1MTg2OTc1Mzg1NTE4MDgvNTU2YjU5ZDdlZGMxZmJiOTQ4NDQ3YjhhYzBkZjk1YWY 2x"/>
                     <div class="min-w-0 flex-1">
                        <div class="flex items-center justify-between gap-2">
                           <div class="subtitle1 overflow-hidden text-ellipsis whitespace-nowrap">chaunceystjohn</div>
                           <div class="text4 text-whop-gray mt-0.5 whitespace-nowrap">7h</div>
                        </div>
                        <div class="text4 text-whop-gray mt-0.5 overflow-hidden text-ellipsis whitespace-nowrap">
                           Member for 2d
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="paragraph2 mt-4 h-[120px] overflow-hidden [-webkit-box-orient:vertical] [display:-webkit-box] [-webkit-line-clamp:5]">I made 5x my monthly subscription in my first day of being in The Haven community. The holistic effect of having (1) excellent analysis, (2) great trade setups, (3) an active community to bounce ideas off, and (4) highly engaged analysts constantly commenting and sharing insights is unmatched.
                  ...
                  <div class="bg-whop-stroke my-4 h-[0.5px] rounded-full"></div>
                  <div class="flex items-center gap-2">
                     ...
                     <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2">
                           <div class="subtitle1 overflow-hidden text-ellipsis whitespace-nowrap">The Haven</div>
                           <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="badge-check" class="w-4 h-4 text-whop-fieldHighlight text-sm" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div class="text4 text-whop-gray mt-0.5 overflow-hidden text-ellipsis whitespace-nowrap">Cryptocurrency Trading Educational Platform</div>
                     </div>
                     <div class="text-whop-fieldHighlight subtitle3 cursor-pointer hover:underline">View</div>
                  </div>
               </a>
            </div>
         ))}
