...
<Banner />
<div class="bg-whop-hover flex items-center justify-center gap-16 p-8 [content-visibility:auto] lg:gap-32">
        <div class="flex flex-col items-center justify-center gap-2">
           <div class="flex items-center justify-center gap-2 text-3xl text-whop-black font-medium" aria-label="$ 269,342,652">
           ...
           <span class="text-base text-whop-gray">Total Purchased on Whop</span>
        </div>
        <div class="flex-col items-center justify-center gap-2 hidden sm:block">
           <div class="flex items-center justify-center gap-2 text-3xl text-whop-black font-medium" aria-label=" 5,118,768">
           ...
           <span class="text-base text-whop-gray">Total Memberships Sold</span>
        </div>
        <div class="flex-col items-center justify-center gap-2 hidden md:block">
           <div class="flex items-center justify-center gap-2 text-3xl text-whop-black font-medium" aria-label=" 10,213">
           ...
           <span class="text-base text-whop-gray">Total Available Products</span>
        </div>
     </div>
