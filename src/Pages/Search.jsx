...
const Search = () => {
    ...
    useEffect(() => {
        ...
        // pageItems = List.slice(indexOfFirstItem, indexOfLastItem);
        setPageItems(filteredList.slice(indexOfFirstItem, indexOfLastItem))
        ...
        if (number < maxPageNumberLimit + 1 && number > minPageNumberLimit) {
            return (
                <li
                    ...
                    id={number}
                    onClick={handleClick}
                    className={`subtitle flex h-8 w-8 cursor-pointer select-none items-center justify-center rounded-md border-2 transition border-transparent hover:bg-whop-hover hover:border-whop-hover active:border-whop-hover-press active:bg-whop-hover-press ${currentPage} == ${number} ? "active" : null `}
                >
                    {number}
                </li>
            );
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="sidebar__check d-flex align-items-center">
                                            <input
                                                ...
                                                value={valz.name}
                                            />
                                            <label className="m-check-label" htmlFor={`price-${keyz}`}>
                                                {valz?.name}
                                            </label>
                                        </div>
                ...
                <div className="flex-1 overflow-x-hidden">
                    <div className="flex items-center justify-between border-solid py-3 pl-5 pr-3 md:mb-1.5 md:py-0 md:pl-4 md:pr-2">
                        <div className="flex flex-1 items-center gap-4 overflow-auto">
                            <div className="text3 text-whop-dark-gray md:text-whop-black whitespace-nowrap md:text-[16px] md:font-semibold md:leading-[22px]">
                                {filteredList && filteredList.length > 0 ? filteredList.length : 0}  products
                            </div>
                    ...
                    <div className="flex items-center justify-between mx-5 mt-1.5 md:mx-0">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button variant="link" className="subtitle flex h-8 select-none items-center justify-center rounded-md border-2 transition border-transparent hover:bg-whop-hover hover:border-whop-hover active:border-whop-hover-press active:bg-whop-hover-press"
                                href="#"
                            ...
                            <Button variant="link" className="subtitle flex h-8 cursor-pointer select-none items-center justify-center rounded-md border-2 transition border-transparent hover:bg-whop-hover hover:border-whop-hover active:border-whop-hover-press active:bg-whop-hover-press"
                                // href="/categories/reselling/page/2/?%3Fhuman_challenge_solution=qlkuwbgdisugbtetwsbdcqk"
                                href="#"
                            ...
                            <div className="text4 text-whop-gray">
                                Showing  {((currentPage - 1) * 10) + 1}  -  {((currentPage - 1) * 10) + 10}  of  {filteredList.length}
                            </div>
                        </div>
                    </div>
