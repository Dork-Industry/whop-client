                ...
                <div className="flex flex-wrap-reverse items-center gap-1">
                   <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                      <div className="flex gap-1">
                         ...
                         <div className="subtitle3 text-whop-black">4.97</div>
                      </div>
                   </div>
             ...
             <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                         <p className="text-text5 text-whop-dark-gray truncate max-w-[200px]" >Members</p>
                      </div>
                   </div>
                </div>
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                         <p className="text-text5 text-whop-dark-gray truncate max-w-[200px]" >New Years Giveaway</p>
                      </div>
                   </div>
                </div>
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                         <p className="text-text5 text-whop-dark-gray truncate max-w-[200px]" >PL Merch</p>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div className="border-whop-stroke hidden h-fit w-[340px] flex-col gap-5 rounded-[10px] border px-6 pb-[30px] pt-6 shadow-xl md:flex">
                ...
                <div className="flex flex-col gap-y-[6px]">
                   ...
                   <div className="flex items-center justify-center space-x-1">
                      ...
                      <div className="text-whop-gray text-text5">Secured by</div>
   ...
   <div className="lg:flex-1 lg:basis-[360px]">
      <div className="flex flex-col gap-6">
         ...
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">🤑</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">24/7 Deals</div>
               <div className="text-paragraph2 text-whop-dark-gray">Deals, Price Errors, &amp; Glitches to help our community save and make money at every hour of every day.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">💸</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">Profitable Flips</div>
               <div className="text-paragraph2 text-whop-dark-gray">Detailed analysis on collectible comic books, vinyls, sports cards, Funko Pop!'s, &amp; other releases to maximize profits.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">🆓</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">Freebies</div>
               <div className="text-paragraph2 text-whop-dark-gray">Free &amp; heavily discounted items from stores like Amazon and food services like Postmates and UberEats.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">⚙</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">Resources &amp; Tools</div>
               <div className="text-paragraph2 text-whop-dark-gray">Numerous guides, info panels, tutorials, and Q&amp;A sessions to ensure our community is the best prepared.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">⚡</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">High Speed Monitors</div>
               <div className="text-paragraph2 text-whop-dark-gray">The fastest, exclusive monitors designed to alert our community of the newest leads and product restocks.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">💼</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">100+ Experienced Staff</div>
               <div className="text-paragraph2 text-whop-dark-gray">We have experts that provide the best leads and guarantee our members' success.</div>
            </div>
         </div>
         <div className="flex gap-6">
            <div className="bg-whop-hover flex h-16 w-16 items-center justify-center rounded-[10px] text-[32px]">📞</div>
            <div className="flex flex-1 flex-col gap-2 overflow-hidden">
               <div className="text-header4">Customer Support</div>
               <div className="text-paragraph2 text-whop-dark-gray">24/7, 1-on-1, customized support from members of the community that will help you succeed.</div>
            </div>
         </div>
      </div>
   </div>
         ...
         <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">So you pay 90$ and don't get Access to everything. </div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">We have a 14 day waiting period before you are eligible to get access to "exclusive" content. 
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">Once accepted and the $90 payment is made, will I receive notifications of all possible deals?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Thanks for your interest in Profit Lounge!
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">How long is the waiting list?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Thanks for your interest in Profit Lounge!
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">How long does it take to know if I got  accepted into profit lounge?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Thanks for your interest in Profit Lounge!
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">Which regions do you support? I am based in Australia. Would it work for me?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Some users do use United States prep centers to sell in the US from other countries. This could be an option for you, feel free to make a ticket in our free server (Deals Central -&gt; discord.gg/profitlounge) to learn more.</div>
                  </div>
                  <div className="text-whop-gray text-paragraph5 md:pl-[100px]">
                     <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar" className="svg-inline--fa fa-calendar fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">Hi I want to know where it's based the deals and services? (i'm from eu)</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Some users do use United States prep centers to sell in the US from the EU. This could be an option for you, feel free to make a ticket in our free server (Deals Central -&gt; discord.gg/profitlounge) to learn more.</div>
                  </div>
                  <div className="text-whop-gray text-paragraph5 md:pl-[100px]">
                     <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar" className="svg-inline--fa fa-calendar fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">How long is the typical wait time?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Thanks for your interest in Profit Lounge!
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">What is the wait time for the waitlist?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Thanks for your interest in Profit Lounge!
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">If you buy the 3-month package, will you get exclusive access instantly instead of the 14-day wait?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Great question! Lowering the 14-day requirement will be determined case by case, pending verification. </div>
                  </div>
                  <div className="text-whop-gray text-paragraph5 md:pl-[100px]">
                     <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar" className="svg-inline--fa fa-calendar fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">Is it only US region or available for Canada? </div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Some users do use United States prep centers to sell in the US from the EU. This could be an option for you, feel free to make a ticket in our free server (Deals Central -&gt; discord.gg/profitlounge) to learn more.</div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">Hello, if I am from Spain, will I be able to find good offers and deals, or is it only designed for people from the United States?</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Some users do use United States prep centers to sell in the US from the EU. This could be an option for you, feel free to make a ticket in our free server (Deals Central -&gt; discord.gg/profitlounge) to learn more.</div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row-reverse sm:gap-6">
               <div className="w-full space-y-3">
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Question:</div>
                     <div className="text-whop-black text-subtitle1">What will it show on my bank statement when you guys take the $90 and how will you notify us when we are in and been charged</div>
                  </div>
                  <div className="flex">
                     <div className="text-subtitle1 hidden min-w-[100px] text-black md:block">Answer:</div>
                     <div className="text-whop-dark-gray text-paragraph2 whitespace-pre-wrap">Great question! We will email the email we have on file a few days before restocking, which gives you plenty of time to reach out to us if you are no longer interested. We also usually announce restocking days on our social media as well.</div>
                  </div>
                  <div className="text-whop-gray text-paragraph5 md:pl-[100px]">
                     <div data-state="closed" className="text-whop-gray focus:outline-none cursor-default inline-block">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar" className="svg-inline--fa fa-calendar fa-fw " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
