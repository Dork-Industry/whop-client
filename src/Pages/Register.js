...
const Register = () => {
    ...
    const onSubmit = async (e) => {
        ...
        await Apiconnect.postData('users/register', indata).then((response) => {
    ...
    const verifysignupotp = () => {
        ...
        Apiconnect.postData('users/verifysignupotp', indata).then((response) => {
            var resz = response.data;
    ...
    const auth = async (credentialResponse) => {
        ...
        Apiconnect.postDataNoauth('users/register', indata).then((response) => {
            var resz = response.data;
            var resz = response.data;
            if (resz.status === 1) {
                navigate('/login');
