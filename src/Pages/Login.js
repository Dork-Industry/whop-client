                            ...
                            <div className="flex flex-col px-6">
                                ...
                                <div className="flex gap-2">
                                    {/* <a target="_self" className="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" className="w-6 h-6 text-whop-brandsDiscord text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                    ...
                                    {/* <a target="_self" className="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#" onClick={() => auth()}>
                                    ...
                                    {/* <a className="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="ethereum" className="w-6 h-6 text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    ...
                                    <a target="_blank" className="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="w-6 h-6 text-whop-brandsTwitter text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <a target="_self" className="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="apple" className="w-6 h-6 text-whop-brandsApple text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                            <path fill="currentColor" d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"></path>
                                        </svg>
                                    </a> */}
                                </div>
                                <div className="text-whop-gray text5 my-6 text-center">Secure login <a className="font-medium underline" target="_blank" href="/tos">Terms</a> &amp; <a className="font-medium underline" target="_blank" href="/privacy">Privacy</a></div>
                            </div>
                            <div className="text-whop-darkGray text-subtitle3 border-whop-stroke font-semibold flex items-center justify-center border-t py-5">
                                New to Whop?
                                <a className="ml-1 text-[#FF6243]" href="/register">Create an account</a>
                            </div>
                        </div>
                    </>)}
                </div>
