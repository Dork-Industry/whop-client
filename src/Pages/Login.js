                ...
                <div class="border-whop-stroke z-10 mb-5 flex min-h-[160px] w-full flex-col bg-white sm:max-w-[420px] sm:rounded-[10px] sm:border sm:shadow-lg">
                    ...
                    <div class="flex flex-col">
                        <div class="flex flex-col px-6">
                            <div class="display2 text-whop-black my-6 text-center" id="auth-title">Sign in to Whop</div>
                            ...
                            <div class="flex gap-2">
                                <a target="_self" class="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" class="w-6 h-6 text-whop-brandsDiscord text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                ...
                                <a class="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="ethereum" class="w-6 h-6 text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                ...
                                <a target="_blank" class="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" class="w-6 h-6 text-whop-brandsTwitter text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                <a target="_self" class="border-whop-stroke hover:bg-whop-hover active:bg-whop-hover-press flex h-10 flex-1 items-center justify-center rounded-md border outline-none transition" href="#">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="apple" class="w-6 h-6 text-whop-brandsApple text-[20px]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                        ...
                        <div class="text-whop-darkGray text-subtitle3 border-whop-stroke font-semibold flex items-center justify-center border-t py-5">New to Whop?<a class="ml-1 text-[#FF6243]" href="/register">Create an account</a></div>                    </div>
                </div>
            </div>
