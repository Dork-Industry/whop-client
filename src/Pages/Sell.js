...
import SellerCounts from '../Components/SellerRegister/SellerCounts.jsx';
import SellAnything from '../Components/SellerRegister/SellAnything.jsx';
                    ...
                    <div className="row">
                        <div className="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                            <div className="page__title-wrapper text-center mb-55">
                                <h2 className="page__title-2">Become a Seller | Register Now!</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                                ...
                                <div className="sign__form">
                                    <form onSubmit={(e) => onSubmit(e)}>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="sign__input-wrapper mb-25 col-md-12">
                            ...
                            <div className='sell_heading'>
                                <div className='sell_heading-1 mx-auto'>
                                    ...
                                    <div className='mt-8 sell_heading-1--buttons'>
                                        <Link to={"/seller-register"} className='bg-orange-button outline-brand rounded-md text-xs py-2 px-3 shadow-orange-button-shadow outline-2 outline-offset-2 rounded-md text-off-white'>Start Selling</Link>
