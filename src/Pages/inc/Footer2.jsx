                    ...
                    <div className="flex flex-col gap-10 self-stretch">
                        ...
                        <div className="flex items-center justify-between self-stretch">
                            ...
                            <div className="flex gap-2">
                                <a target="_blank" className="text-whop-gray hover:text-whop-dark-gray px-2.5 py-2 transition" href="https://discord.com/">
                                ...
                                <a target="_blank" className="text-whop-gray hover:text-whop-dark-gray px-2.5 py-2 transition" href="https://twitter.com/">
                                ...
                                <a target="_blank" className="text-whop-gray hover:text-whop-dark-gray px-2.5 py-2 transition" href="https://www.youtube.com/">
